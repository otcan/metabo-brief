...
export function scorePathwayModel({ panel, parsed, findings, model }) {
  ...
  return {
    ...
    modelStatus: model.status || "experimental",
    reviewLevel: model.reviewLevel || null,
    reviewedAt: model.reviewedAt || null,
    reviewChecklistVersion: model.reviewChecklistVersion || null,
    reviewNotes: model.reviewNotes || null,
    knownWeaknesses: model.knownWeaknesses || [],
    releaseUse: model.releaseUse || null,
    modelCard: model.__manifest?.modelCard || model.modelCard || null,
