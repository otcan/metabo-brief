...
Do the curated SNP findings favor lower or higher modelled estrogen metabolism handling demand?

## Score axis

- Negative pole: Lower modelled estrogen handling demand
- Positive pole: Higher modelled estrogen handling demand

## Included mechanisms

- Phase I transformation
- conjugation context
- COMT and UGT context
...
| rs8175347 | 3 | 1 | ugt1a1-enzyme-activity | ugt1a1-enzyme-activity | conservative, exploratory |
| rs887829 | 3 | 1 | ugt1a1-biomarker-tendency | ugt1a1-biomarker-tendency | conservative, exploratory |
...
- Not included: Measured hormones, cycle timing, medication use, pregnancy, liver function, clinical diagnosis.

## Versioning

- Model ID: estrogen-metabolism
- Model version: 0.1.0
